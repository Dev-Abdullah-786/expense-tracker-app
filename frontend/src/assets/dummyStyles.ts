...
export const transactionItemStyles = {
  ...
  // Icon styles
  iconContainer: (iconClass: string, classes: { iconBg: string }) =>
  ...
  // Amount display
  amountText: (amountClass: string, classes: {text: string}) => `${amountClass} ${classes.text}`,

  // Button styles
  saveButton: (classes: {button: string}) => `p-2 ${classes.button} rounded-lg`,
  cancelButton: "p-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400",
  editButton: (classes: {text: string, bg: string}) => `p-2 ${classes.text} rounded-lg hover:${classes.bg}`,
  deleteButton: (classes: {text: string, bg: string}) =>
